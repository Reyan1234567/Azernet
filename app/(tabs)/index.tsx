...
import { ShoppingCart, Package, TrendingUp, DollarSign } from "lucide-react-native";
...
const Index = () => {
  ...
  const stats = [
    { label: 'Total Revenue', value: '$1,440', icon: DollarSign, color: '#10b981' },
    { label: 'Total Orders', value: '96', icon: ShoppingCart, color: '#3b82f6' },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: bgColor }}>
      ...
      >
        ...
        <Text variant="heading" style={{ color: textColor, fontSize: 28 }}>Dashboard</Text>
      ...
      <View style={styles.statsGrid}>
        {stats.map((stat, index) => (
          <Card key={index} style={[styles.statCard, { backgroundColor: cardBg }]}>
            <View style={styles.statContent}>
              ...
              <Text variant="title" style={{ color: textColor, fontSize: 24, fontWeight: 'bold', marginTop: 4 }}>
                {stat.value}
              </Text>
            </View>
          </Card>
      ...
      <View style={styles.chartsSection}>
        <Text variant="subtitle" style={{ color: textColor, marginBottom: 12, fontSize: 18 }}>
          Analytics
        </Text>
      ...
      <View style={styles.actionsSection}>
        ...
        <View style={styles.actions}>
          ...
          <Button 
            onPress={() => router.push("/createPartner")}
            variant="outline"
            style={{ flex: 1 }}
          >
            Add Partner
